      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="{{ asset('assets/img/about2.png') }}" class="img-fluid" alt="">
          </div>
              ...
              <div class="row">
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
					...
					<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto temporibus sint sequi asperiores! Similique, eum? Praesentium, .</p>
                  </div>
                </div>
                <div class="col-xl-4 d-flex align-items-stretch">
                  <div class="icon-box mt-4 mt-xl-0">
                    <i class="bx bx-cube-alt"></i>
                    <h4>Help to Develop your Business</h4>
        ...
        <div class="row" data-aos="zoom-in" data-aos-delay="100">
          ...
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              ...
              <h3><a href="">Audio Production</a></h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
          ...
          <div class="col-lg-3 col-md-4 mt-4">
            <div class="icon-box">
              ...
              <h3><a href="">SEO - Search Engine Optimization</a></h3>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-3">
            <div class="course-item">
              ...
              <div class="course-content">
                ...
                <h3><a href="{{ route('student.select-course',$course->id)}}">{{ $course->Name }}</a></h3>
