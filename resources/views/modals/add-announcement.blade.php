<div class="modal fade addannouncement" wire:ignore.self tabindex="-1" role="dialog"
        ...
        <form wire:submit.prevent="save">
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" class="form-control" rows="6" placeholder="Type your announcement here...."
                        wire:model="msg" id="msg"></textarea>
