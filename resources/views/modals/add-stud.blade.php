      ...
      <div class="modal-body">
        <form wire:submit.prevent="save" enctype="multipart/form-data">
          <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="Enter Student Full Name" wire:model="fullname">
            <span class="text-danger">@error('fullname') {{ $message }} @enderror</span>
          </div>

          <div class="form-group">
            <label for="">Date of Birth</label>
            <input type="date" class="form-control" wire:model="dob" ></input>
            <span class="text-danger">@error('dob')  {{ $message }} @enderror</span>
          </div>

          <div class="form-group">
            <label for="">Contact</label>
            <input type="text" class="form-control" placeholder="Enter student Mobile/Lan line" wire:model="contact">
            <span class="text-danger">@error('contact')  {{ $message }} @enderror</span>
          </div>

          <div class="form-group">
            <label>Contact (Whatsapp)</label>
            <input type="text" class="form-control" wire:model="whatsapp" placeholder="Enter Student Whatsapp Number..">
          ...
          <div class="form-group">
            ...
            <textarea type="text" class="form-control" rows="3"placeholder="Enter Student Home Address" wire:model="address" ></textarea>
