                ...
                <tbody>
                    @forelse ($paymentdone as $pyment )
                        ...
                        <tr>
                            ...
                            <td><a href="{{ route('student.stud-download', $file->file_name) }}" class="btn bg-indigo"><i class="fas fa-cloud-download-alt mr-2"></i>Download</a></td>
                        </tr>
                        @endforeach
                    @empty
                        
                        <h5 class="text-danger text-center"><strong><i class="fas fa-exclamation-triangle mr-2"></i>You have to pay your class fee first</strong></h5>
