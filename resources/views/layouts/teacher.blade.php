      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item">
                <a href="{{ route('teacher.home') }}" class="nav-link {{ (request()->is('teacher/dashboard*')) ? 'active' : ''}}">
                  <i class="nav-icon fas fa-home"></i>
                  <p>Dashboard</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('teacher.myclass') }}" class="nav-link {{ (request()->is('teacher/myclass*')) ? 'active' : ''}}">
