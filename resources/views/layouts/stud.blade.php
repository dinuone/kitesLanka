        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a class="dropdown-item bg-maroon" href="{{ route('student-logout') }}" onclick="event.preventDefault();
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4" style="position: fixed">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" class="d-block">{{ Auth::guard('student')->user()->FullName }}</a>
                    </div>
                </div>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            <a href="{{ route('student-myclass') }}"
                                class="nav-link {{ request()->is('student/myclass*') ? 'active' : '' }}">
                                <i class="nav-icon fa fa-user-plus"></i>
                                <p>My Class</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('student-classfee') }}"
