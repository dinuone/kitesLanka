                                ...
                                <td>
                                    <table align="center" cellpadding="0" cellspacing="0" class="page-center"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <a data-click-track-id="37"
                                                        href="{{ route('student-reset.form', $token) }}"
                                ...
                                <td>
                                    <table align="center" cellpadding="0" cellspacing="0" class="footer-center"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td colspan="2"
                                                    style="padding-top: 72px; padding-bottom: 5px; width: 100%;">
                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    us via our <a data-click-track-id="1053"
                                                        href="https://kiteslanka.com"
                                                        style="font-weight: 500; color: #ffffff" target="_blank">Contact
                                                        Us</a>.
                                                </td>
                                            </tr>
                                            <tr>
